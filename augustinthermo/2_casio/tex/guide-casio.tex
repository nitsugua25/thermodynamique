...
\vspace{-0.9cm}
\begin{center}
\small\itshape Sept scripts et 31 fiches écran pour traiter les exercices types de l'examen. Tous ont été vérifiés sur les
...
\subsection*{Les 31 fiches images}
En plus des scripts, le dossier \texttt{images/} contient 31 fiches PNG à la taille exacte de l'écran
...
\item \textbf{D01--D23 (Démarche)} : l'ordre dans lequel rédiger, avec un exemple chiffré vérifié en pied
de fiche. Essence en 2 fiches (volumes/points puis combustion/rendement), diesel en 2, combustion en 3,
frigo en 2, transformations en 2, plus turbine, entropie, échange thermique, rendements, puissance,
vérifications et ordres de grandeur.
\item \textbf{S01--S08 (Schéma)} : les dessins à avoir en tête (cycles $p$-$V$ essence et diesel, les 4
transformations par un même point, organes du frigo, diagramme $\log p$-$h$, moteur vs récepteur,
fermé vs ouvert, cycle de Joule).
\end{itemize}
Elles sont aussi rassemblées dans \texttt{fiches-planches.pdf} pour être imprimées ou relues sur PC.
