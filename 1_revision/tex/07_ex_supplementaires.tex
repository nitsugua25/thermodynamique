...
\smallskip
La méthode ci-dessous correspond aux fiches calculatrice \texttt{E01--E12} (cycle, essence,
frigo) et \texttt{L01--L02} (lecture du diagramme $\log p$-$h$) de \texttt{2\_casio/images/} ---
mêmes formules, chiffres retapés proprement plutôt que des captures d'écran.
\end{info}
...
Réponses officielles  : $W_{tot}\approx124{,}4-306{,}5+0+181{,}8\approx0$~kJ,
...
$\log p$-$h$ (points 1 à 4) et on calcule la PSN.
\end{enonce}
...
\begin{verif}
\textbf{Valeurs officielles}  : $h_1\approx1760$~kJ/kg,
...
\begin{info}
\textbf{Variante avec surchauffe/sous-refroidissement}  : même
